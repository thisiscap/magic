...
function magicEightBall() {
  ...
  var xDeg = Math.floor(Math.random() * 40);
  var yDeg = Math.floor(Math.random() * 40);
  var zDeg = Math.floor(Math.random() * 40);
  ...
  style.sheet.insertRule('@keyframes transformAndScale { 0% { transform-origin: 50% 50%; transform: rotate3d(' + xDeg + ', -' + yDeg + ',' + zDeg + ',' + deg + 'deg) scale3d(.8, .8, .8); } 100% { } }', 0);
